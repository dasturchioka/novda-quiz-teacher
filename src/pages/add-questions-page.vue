...
<template>
	<div
		class="add-questions-page container mx-auto sm:px-4 px-2 flex h-screen items-center justify-center relative"
	>
		<Button class="absolute left-4 top-4" @click="restart" variant="destructive"
